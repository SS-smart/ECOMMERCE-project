...
<script>
  ...
  export default {
    ...
    methods:{
      //把发请求的这个action封装带一个函数里面
      //将来需要再次发请求，你只需要再调用这个函数即可
      getData(){
      ...
      removeCategoryName(){
        ...
        // 但是你把相应的字段百年未underfined，当前这个字段不会带给服务器
    ...
    watch:{
      $route(newValue,oldValue){
                //每一次请求完毕应该把相应的1，2，3级分类的id重置空的，让 他接受下一次的相应1，2，3
